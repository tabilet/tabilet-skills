...
for (const profile of ['web', 'headless']) {
  ...
  execFileSync(process.execPath, [resolve('node_modules/@deepseek-ai/dsh/lib/bin.js'), 'plugin', '--profile', profile, 'add', resolve('tabilet-skills-1.4.0.tgz'), '--ignore-scripts'], { env, stdio: 'inherit' });
}
