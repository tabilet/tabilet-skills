...
export function activeFixture(count = 2): Map<string, string> {
  const files = new Map<string, string>([['AGENTS.md', '# Project instructions\n'], ['memory-bank/architecture.md', '# Architecture\n'], ['memory-bank/product.md', '# Product\nShared project memory.\n'], ['memory-bank/tech-stack.md', '# Stack\n'], ['memory-bank/lessons.md', '# Lessons\n']]);
